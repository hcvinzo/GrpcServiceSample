...
using GrpcServiceSample.Services.v1;
...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    //.WriteTo.File("logs/GrpcServiceSample-.txt", rollingInterval: RollingInterval.Day)
    .CreateLogger();
...
try
{
    ...
    {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "Grpc Sample API", Version = "v1" });
        ...
        c.DocumentFilter<GrpcServiceSample.GrpcDocumentFilter>();
    });
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Grpc Sample API V1");
